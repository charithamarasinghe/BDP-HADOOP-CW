...
public class MatchesWithResultCount {
    ...
    public static class MapperClass extends
        ...
        public void map(Object key, Text value, Context context)
            ...
            String city = numArray[6];

            if(!homeScore.equals(awayScore) && !city.equals("city")) {
                drawnMatchCount.set("Matches with result ");
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "MatchesWithResultCount");
        job.setJarByClass(MatchesWithResultCount.class);
